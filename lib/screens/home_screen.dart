                                                    ...
                                                    GridView.count(
                                                        ...
                                                        children: [
                                                            _buildActionCard(
                                                                ...
                                                                2, // Navigate to index 2 (Emergency Contacts)
                                                            ),
                                                            _buildActionCard(
                                                                context,
                                                                'Learning\nModules',
                                                                Icons.school,
                                                                1, // Navigate to index 1 (Learning)
                                                            ),
                                                            _buildActionCard(
                                                                context,
                                                                'Safety\nDrills',
        ...
        return GestureDetector(
            onTap: () {
                if (navigationIndex == -1) {
                    ...
                    final homeScreenState = context.findAncestorStateOfType<State<StatefulWidget>>();
                    if (homeScreenState != null) {
                        (homeScreenState as dynamic).setState(() {
                            (homeScreenState as dynamic)._currentIndex = navigationIndex;
                        });
                    }
                } else {
                    ScaffoldMessenger.of(context).showSnackBar(
